...
//        assertEquals(1, Play.solution(1, 4));
//        assertEquals(2, Play.solution(1, 5));
//        assertEquals(3, Play.solution(1, 6));
        assertEquals(2, Play.solution(1, 7));
//        assertEquals(3, Play.solution(1, 8));
//        assertEquals(4, Play.solution(1, 9));
//        assertEquals(3, Play.solution(1, 10));
//
        assertEquals(-1, Play.solution(-1, 2));
